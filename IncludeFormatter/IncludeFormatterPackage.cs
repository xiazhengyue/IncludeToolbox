...
namespace IncludeFormatter
{
    ...
    [Guid(IncludeFormatterPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class IncludeFormatterPackage : Package
    {
        /// <summary>
        /// IncludeFormatterPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "0ef7bd3a-65d2-41e6-89af-27ef58296075";

        /// <summary>
        /// Initializes a new instance of the <see cref="IncludeFormatter"/> class.
        /// </summary>
        public IncludeFormatterPackage()
        {
